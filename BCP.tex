...
\usepackage[a4paper,%This enables easy large-letter editions (A4)
bindingoffset=10mm,%having an inner margin offset prevents text falling into the gutter
inner=20mm,
outer=20mm,
top=20mm,
bottom=20mm,
...
\usepackage{lettrine}
\newcommand{\lett}[2]{\lettrine[image=true,realheight=true,lines=2]{dropcaps/#1.png}{{\lowercase{#2}}}}
...
\renewcommand{\fancyheadoffset}{10pt}
\afterpage{\fancyhead{}}
}
...
\include{pages/00-titlepage}
\include{pages/00-copyright}
\frontmatter
\tableofcontents
\clearpage
\mainmatter
